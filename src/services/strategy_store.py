...
_STRUCTURE_MATCH_TERMS: dict[str, tuple[str, ...]] = {
    ...
    "futures_open_drive": ("f1", "open", "drive", "futures"),
    "futures_vwap_reclaim": ("f2", "vwap", "futures", "reclaim"),
    "futures_lunch_fade": ("f3", "lunch", "fade", "futures"),
    "futures_afternoon_trend": ("f4", "afternoon", "trend", "futures"),
    "futures_failed_breakout": ("f5", "failed", "breakout", "futures"),
